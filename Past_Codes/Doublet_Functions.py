...
def calcDoubletFraction(input_phi, input_Ca, input_criteria_T, input_criteria_Dms, make_plot, *input_others):
    ...
    [[doublet fraction], timesteps, [state series], diffpos]
    ...
    for criteria_Dm in criteria_Dms:
        ...
        ctypes.c_void_p(end_time.ctypes.data))
    ...
    if (make_plot == 1):
        ...
        if WriteProps == 3669:
            ax1.set_title("Two-cell system\nphi={}, Ca={}, angle={}, Re=0.1, h=24".format(phi, Ca, angle), fontsize = 24)
        else:
            ax1.set_title("Suspension\nphi={}, Ca={}, Re=0.1, D={}, eqWCA={}, h=24".format(phi, Ca, D, eqWCA), fontsize = 24)
    ...
    #return [output_DF, timesteps, output_state, diffpos, uncorrected_diffpos, COMs, COMs_NB]
    return [output_DF, end_time[0], output_state, diffpos]
